...
const ResultBox = ({ textResult }) => {
  return (
    <div className="mt-5 max-w-xs h-48 text-left bg-indigo-100 rounded-lg px-3 py-2 overflow-y-scroll sm:mt-0 sm:ml-8 sm:h-64 sm:w-1/2 sm:max-w-none lg:self-center">
      {textResult ? (
